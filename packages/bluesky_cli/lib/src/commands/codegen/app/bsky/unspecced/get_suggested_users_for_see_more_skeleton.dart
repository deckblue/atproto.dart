...
final class GetSuggestedUsersForSeeMoreSkeletonCommand extends QueryCommand {
  GetSuggestedUsersForSeeMoreSkeletonCommand() {
    argParser
      ..addOption(
        "viewer",
        help:
  ...
  @override
  final String name = "get-suggested-users-for-see-more-skeleton";
  ...
  final String invocation =
      "bsky app-bsky-unspecced get-suggested-users-for-see-more-skeleton [--viewer=<value>] [--category=<value>] [--limit=<value>]";
