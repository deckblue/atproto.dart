...
final class GetOnboardingSuggestedUsersSkeletonCommand extends QueryCommand {
  GetOnboardingSuggestedUsersSkeletonCommand() {
    argParser
      ..addOption(
        "viewer",
        help:
  ...
  @override
  final String name = "get-onboarding-suggested-users-skeleton";
