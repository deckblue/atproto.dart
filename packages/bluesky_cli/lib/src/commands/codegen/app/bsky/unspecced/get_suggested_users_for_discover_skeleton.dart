...
final class GetSuggestedUsersForDiscoverSkeletonCommand extends QueryCommand {
  GetSuggestedUsersForDiscoverSkeletonCommand() {
    argParser
      ..addOption(
        "viewer",
        help:
  ...
  @override
  final String name = "get-suggested-users-for-discover-skeleton";
