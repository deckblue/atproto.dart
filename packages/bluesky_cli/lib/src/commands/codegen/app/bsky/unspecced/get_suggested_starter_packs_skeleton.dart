...
final class GetSuggestedStarterPacksSkeletonCommand extends QueryCommand {
  GetSuggestedStarterPacksSkeletonCommand() {
    argParser
      ..addOption(
        "viewer",
        help:
  ...
  @override
  final String name = "get-suggested-starter-packs-skeleton";
