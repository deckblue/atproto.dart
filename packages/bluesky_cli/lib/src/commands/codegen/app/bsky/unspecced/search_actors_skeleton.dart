...
final class SearchActorsSkeletonCommand extends QueryCommand {
  SearchActorsSkeletonCommand() {
    argParser
      ..addOption(
        "q",
        help:
            r"Search query string; syntax, phrase, boolean, and faceting is unspecified, but Lucene query syntax is recommended. For typeahead search, only simple term match is supported, not full syntax.",
        mandatory: true,
      )
      ..addOption(
        "viewer",
  ...
  @override
  final String name = "search-actors-skeleton";
