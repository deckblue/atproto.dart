...
final class GetOnboardingSuggestedStarterPacksSkeletonCommand
    extends QueryCommand {
  GetOnboardingSuggestedStarterPacksSkeletonCommand() {
    argParser
      ..addOption(
        "viewer",
        help:
  ...
  @override
  final String name = "get-onboarding-suggested-starter-packs-skeleton";
