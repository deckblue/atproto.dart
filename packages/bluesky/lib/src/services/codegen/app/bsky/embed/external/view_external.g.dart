      ...
      ($checkedConvert) {
        final val = _$EmbedExternalViewExternalImpl(
          ...
          updatedAt: $checkedConvert('updatedAt',
              (v) => v == null ? null : DateTime.parse(v as String)),
          readingTime:
              $checkedConvert('readingTime', (v) => (v as num?)?.toInt()),
          ...
          source: $checkedConvert(
              ...
              (v) => _$JsonConverterFromJson<Map<String, dynamic>,
                      EmbedExternalViewExternalSource>(v,
                  const EmbedExternalViewExternalSourceConverter().fromJson)),
...
Map<String, dynamic> _$$EmbedExternalViewExternalImplToJson(
    ...
    <String, dynamic>{
      ...
      if (_$JsonConverterToJson<Map<String, dynamic>,
                  EmbedExternalViewExternalSource>(instance.source,
      ...
      if (instance.associatedProfiles
              ?.map(const ProfileViewBasicConverter().toJson)
              .toList()
          case final value?)
        'associatedProfiles': value,
