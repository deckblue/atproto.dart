...
class _$ProfileViewBasicImpl implements _ProfileViewBasic {
  ...
  @override
  String toString() {
    return 'ProfileViewBasic(\$type: ${$type}, did: $did, handle: $handle, displayName: $displayName, avatar: $avatar, associated: $associated, viewer: $viewer, labels: $labels, createdAt: $createdAt, verification: $verification, status: $status, \$unknown: ${$unknown})';
  }
