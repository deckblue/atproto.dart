...
enum KnownJobStatusState implements Serializable {
  @JsonValue('JOB_STATE_CREATED')
  jOB_STATE_CREATED('JOB_STATE_CREATED'),
  @JsonValue('JOB_STATE_ENCODING')
  jOB_STATE_ENCODING('JOB_STATE_ENCODING'),
  @JsonValue('JOB_STATE_ENCODED')
  jOB_STATE_ENCODED('JOB_STATE_ENCODED'),
  @JsonValue('JOB_STATE_SCANNING')
  jOB_STATE_SCANNING('JOB_STATE_SCANNING'),
  @JsonValue('JOB_STATE_SCANNED')
  jOB_STATE_SCANNED('JOB_STATE_SCANNED'),
  @JsonValue('JOB_STATE_UPLOADING')
  jOB_STATE_UPLOADING('JOB_STATE_UPLOADING'),
  @JsonValue('JOB_STATE_UPLOADED')
