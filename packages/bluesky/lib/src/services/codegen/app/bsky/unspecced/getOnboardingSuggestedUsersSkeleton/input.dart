...
@freezed
abstract class UnspeccedGetOnboardingSuggestedUsersSkeletonInput
    with _$UnspeccedGetOnboardingSuggestedUsersSkeletonInput {
  static const knownProps = <String>['viewer', 'category', 'limit'];

  @JsonSerializable(includeIfNull: false)
  const factory UnspeccedGetOnboardingSuggestedUsersSkeletonInput({
...
extension UnspeccedGetOnboardingSuggestedUsersSkeletonInputExtension
    on UnspeccedGetOnboardingSuggestedUsersSkeletonInput {
...
final class UnspeccedGetOnboardingSuggestedUsersSkeletonInputConverter
  ...
  @override
  UnspeccedGetOnboardingSuggestedUsersSkeletonInput fromJson(
    Map<String, dynamic> json,
  ) {
    return UnspeccedGetOnboardingSuggestedUsersSkeletonInput.fromJson(
      translate(
        json,
        UnspeccedGetOnboardingSuggestedUsersSkeletonInput.knownProps,
      ),
    );
  }
