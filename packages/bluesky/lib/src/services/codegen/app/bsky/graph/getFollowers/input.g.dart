        ...
        final val = _$GraphGetFollowersInputImpl(
          ...
          sort: $checkedConvert(
              ...
              (v) => _$JsonConverterFromJson<String, GraphGetFollowersSort>(
                  v, const GraphGetFollowersSortConverter().fromJson)),
...
Map<String, dynamic> _$$GraphGetFollowersInputImplToJson(
    ...
    <String, dynamic>{
      ...
      if (_$JsonConverterToJson<String, GraphGetFollowersSort>(
              instance.sort, const GraphGetFollowersSortConverter().toJson)
          case final value?)
        'sort': value,
