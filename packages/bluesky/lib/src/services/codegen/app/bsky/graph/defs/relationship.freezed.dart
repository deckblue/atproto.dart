...
mixin _$Relationship {
  ...
  @AtUriConverter()
  AtUri? get blockedBy => throw _privateConstructorUsedError;

  /// if the actor blocks this DID via a block list, this is the AT-URI of the listblock record
  @AtUriConverter()
  AtUri? get blockingByList => throw _privateConstructorUsedError;

  /// if the actor is blocked by this DID via a block list, contains the AT-URI of the listblock record
  @AtUriConverter()
  AtUri? get blockedByList => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      ...
      blockingByList: freezed == blockingByList
          ...
          : blockingByList // ignore: cast_nullable_to_non_nullable
              as AtUri?,
      blockedByList: freezed == blockedByList
          ? _value.blockedByList
          : blockedByList // ignore: cast_nullable_to_non_nullable
              as AtUri?,
...
class _$RelationshipImpl implements _Relationship {
  const _$RelationshipImpl(
      ...
      @AtUriConverter() this.blockedBy,
      @AtUriConverter() this.blockingByList,
      @AtUriConverter() this.blockedByList,
  ...
  @override
  @AtUriConverter()
  final AtUri? blockedBy;

  /// if the actor blocks this DID via a block list, this is the AT-URI of the listblock record
  @override
  @AtUriConverter()
  final AtUri? blockingByList;

  /// if the actor is blocked by this DID via a block list, contains the AT-URI of the listblock record
  @override
  @AtUriConverter()
  final AtUri? blockedByList;
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.blockedByList, blockedByList) ||
...
abstract class _Relationship implements Relationship {
  const factory _Relationship(
      ...
      @AtUriConverter() final AtUri? blockedBy,
      @AtUriConverter() final AtUri? blockingByList,
      @AtUriConverter() final AtUri? blockedByList,
