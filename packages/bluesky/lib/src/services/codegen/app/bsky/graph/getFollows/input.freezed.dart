...
mixin _$GraphGetFollowsInput {
  ...
  @GraphGetFollowsSortConverter()
  GraphGetFollowsSort? get sort => throw _privateConstructorUsedError;
...
abstract class $GraphGetFollowsInputCopyWith<$Res> {
  ...
  $Res call(
      ...
      int limit,
      String? cursor,
      @GraphGetFollowsSortConverter() GraphGetFollowsSort? sort,
...
class _$GraphGetFollowsInputCopyWithImpl<$Res,
  ...
  $GraphGetFollowsSortCopyWith<$Res>? get sort {
    ...
    return $GraphGetFollowsSortCopyWith<$Res>(_value.sort!, (value) {
...
class _$GraphGetFollowsInputImpl implements _GraphGetFollowsInput {
  const _$GraphGetFollowsInputImpl(
      ...
      this.limit = 50,
      this.cursor,
      @GraphGetFollowsSortConverter() this.sort,
  ...
  @override
  @GraphGetFollowsSortConverter()
  final GraphGetFollowsSort? sort;
...
abstract class _GraphGetFollowsInput implements GraphGetFollowsInput {
  const factory _GraphGetFollowsInput(
      ...
      final int limit,
      final String? cursor,
      @GraphGetFollowsSortConverter() final GraphGetFollowsSort? sort,
