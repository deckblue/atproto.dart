...
_$ConfigRegionRuleIfAssuredOverAgeImpl
    _$$ConfigRegionRuleIfAssuredOverAgeImplFromJson(Map json) => $checkedCreate(
          r'_$ConfigRegionRuleIfAssuredOverAgeImpl',
          json,
          ($checkedConvert) {
            final val = _$ConfigRegionRuleIfAssuredOverAgeImpl(
              $type: $checkedConvert(
                  r'$type',
                  (v) =>
                      v as String? ??
...
Map<String, dynamic> _$$ConfigRegionRuleIfAssuredOverAgeImplToJson(
        _$ConfigRegionRuleIfAssuredOverAgeImpl instance) =>
    <String, dynamic>{
