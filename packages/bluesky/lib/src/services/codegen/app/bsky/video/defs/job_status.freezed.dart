...
mixin _$JobStatus {
  ...
  @JobStatusStateConverter()
  JobStatusState get state => throw _privateConstructorUsedError;
...
abstract class $JobStatusCopyWith<$Res> {
  ...
  $Res call(
      ...
      String jobId,
      String did,
      @JobStatusStateConverter() JobStatusState state,
      int? progress,
...
class _$JobStatusCopyWithImpl<$Res, $Val extends JobStatus>
  ...
  @pragma('vm:prefer-inline')
  $JobStatusStateCopyWith<$Res> get state {
    return $JobStatusStateCopyWith<$Res>(_value.state, (value) {
...
class _$JobStatusImpl implements _JobStatus {
  const _$JobStatusImpl(
      ...
      required this.jobId,
      required this.did,
      @JobStatusStateConverter() required this.state,
      this.progress,
...
abstract class _JobStatus implements JobStatus {
  const factory _JobStatus(
      ...
      @JobStatusStateConverter() required final JobStatusState state,
      final int? progress,
