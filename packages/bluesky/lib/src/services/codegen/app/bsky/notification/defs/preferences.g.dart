...
Map<String, dynamic> _$$PreferencesImplToJson(_$PreferencesImpl instance) =>
    <String, dynamic>{
      ...
      'likeViaRepost':
          const FilterablePreferenceConverter().toJson(instance.likeViaRepost),
      ...
      'repostViaRepost': const FilterablePreferenceConverter()
          .toJson(instance.repostViaRepost),
      'starterpackJoined':
          const PreferenceConverter().toJson(instance.starterpackJoined),
      'subscribedPost':
          const PreferenceConverter().toJson(instance.subscribedPost),
