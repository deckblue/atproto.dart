...
mixin _$UnspeccedGetPostThreadV2Input {
  ...
  @AtUriConverter()
  AtUri get anchor => throw _privateConstructorUsedError;
  ...
  UnspeccedGetPostThreadV2Sort? get sort => throw _privateConstructorUsedError;
...
class _$UnspeccedGetPostThreadV2InputCopyWithImpl<$Res,
    ...
    return _then(_value.copyWith(
      ...
      below: null == below
          ...
          : below // ignore: cast_nullable_to_non_nullable
              as int,
      branchingFactor: null == branchingFactor
      ...
      sort: freezed == sort
          ...
          : sort // ignore: cast_nullable_to_non_nullable
              as UnspeccedGetPostThreadV2Sort?,
  ...
  $UnspeccedGetPostThreadV2SortCopyWith<$Res>? get sort {
    ...
    return $UnspeccedGetPostThreadV2SortCopyWith<$Res>(_value.sort!, (value) {
...
class _$UnspeccedGetPostThreadV2InputImpl
  ...
  const _$UnspeccedGetPostThreadV2InputImpl(
      {@AtUriConverter() required this.anchor,
      this.above = true,
      this.below = 6,
      this.branchingFactor = 10,
      @UnspeccedGetPostThreadV2SortConverter() this.sort,
  ...
  @override
  @UnspeccedGetPostThreadV2SortConverter()
  final UnspeccedGetPostThreadV2Sort? sort;
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, anchor, above, below,
      branchingFactor, sort, const DeepCollectionEquality().hash(_$unknown));
...
abstract class _UnspeccedGetPostThreadV2Input
  ...
  const factory _UnspeccedGetPostThreadV2Input(
          {@AtUriConverter() required final AtUri anchor,
          final bool above,
          final int below,
          final int branchingFactor,
          @UnspeccedGetPostThreadV2SortConverter()
  ...
  @override
  @UnspeccedGetPostThreadV2SortConverter()
  UnspeccedGetPostThreadV2Sort? get sort;
  @override
  Map<String, dynamic>? get $unknown;
