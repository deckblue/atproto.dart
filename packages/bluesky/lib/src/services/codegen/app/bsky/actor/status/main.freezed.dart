...
mixin _$ActorStatusRecord {
  ...
  @ActorStatusStatusConverter()
  ActorStatusStatus get status => throw _privateConstructorUsedError;
...
class _$ActorStatusRecordCopyWithImpl<$Res, $Val extends ActorStatusRecord>
  ...
  @pragma('vm:prefer-inline')
  $ActorStatusStatusCopyWith<$Res> get status {
    return $ActorStatusStatusCopyWith<$Res>(_value.status, (value) {
...
class _$ActorStatusRecordImpl implements _ActorStatusRecord {
  ...
  @override
  @ActorStatusStatusConverter()
  final ActorStatusStatus status;
  @override
  @UActorStatusEmbedConverter()
