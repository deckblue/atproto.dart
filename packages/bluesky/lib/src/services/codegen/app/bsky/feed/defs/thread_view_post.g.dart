      ...
      ($checkedConvert) {
        final val = _$ThreadViewPostImpl(
          ...
          replies: $checkedConvert(
              'replies',
              (v) => (v as List<dynamic>?)
                  ?.map((e) => const UThreadViewPostRepliesConverter()
                      .fromJson(e as Map<String, dynamic>))
                  .toList()),
          threadContext: $checkedConvert(
              'threadContext',
              (v) =>
                  _$JsonConverterFromJson<Map<String, dynamic>, ThreadContext>(
                      v, const ThreadContextConverter().fromJson)),
...
Map<String, dynamic> _$$ThreadViewPostImplToJson(
    ...
    <String, dynamic>{
      ...
      if (_$JsonConverterToJson<Map<String, dynamic>, UThreadViewPostParent>(
      ...
      if (instance.replies
          ...
          case final value?)
        'replies': value,
      if (_$JsonConverterToJson<Map<String, dynamic>, ThreadContext>(
              instance.threadContext, const ThreadContextConverter().toJson)
          case final value?)
        'threadContext': value,
