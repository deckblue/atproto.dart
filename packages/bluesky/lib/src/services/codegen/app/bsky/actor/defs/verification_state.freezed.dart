...
mixin _$VerificationState {
  ...
  VerificationStateVerifiedStatus get verifiedStatus =>
      throw _privateConstructorUsedError;

  /// The user's status as a trusted verifier.
  @VerificationStateTrustedVerifierStatusConverter()
  VerificationStateTrustedVerifierStatus get trustedVerifierStatus =>
      throw _privateConstructorUsedError;
...
abstract class $VerificationStateCopyWith<$Res> {
  ...
  $Res call(
      ...
      @VerificationStateVerifiedStatusConverter()
      VerificationStateVerifiedStatus verifiedStatus,
      @VerificationStateTrustedVerifierStatusConverter()
      VerificationStateTrustedVerifierStatus trustedVerifierStatus,
      Map<String, dynamic>? $unknown});

  $VerificationStateVerifiedStatusCopyWith<$Res> get verifiedStatus;
  $VerificationStateTrustedVerifierStatusCopyWith<$Res>
      get trustedVerifierStatus;
}
...
class _$VerificationStateCopyWithImpl<$Res, $Val extends VerificationState>
    ...
    return _then(_value.copyWith(
      ...
      verifiedStatus: null == verifiedStatus
          ...
          : verifiedStatus // ignore: cast_nullable_to_non_nullable
              as VerificationStateVerifiedStatus,
      trustedVerifierStatus: null == trustedVerifierStatus
          ...
          : trustedVerifierStatus // ignore: cast_nullable_to_non_nullable
              as VerificationStateTrustedVerifierStatus,
  ...
  @pragma('vm:prefer-inline')
  $VerificationStateVerifiedStatusCopyWith<$Res> get verifiedStatus {
    return $VerificationStateVerifiedStatusCopyWith<$Res>(_value.verifiedStatus,
        (value) {
      return _then(_value.copyWith(verifiedStatus: value) as $Val);
    });
  }
  ...
  $VerificationStateTrustedVerifierStatusCopyWith<$Res>
      get trustedVerifierStatus {
    return $VerificationStateTrustedVerifierStatusCopyWith<$Res>(
        _value.trustedVerifierStatus, (value) {
      return _then(_value.copyWith(trustedVerifierStatus: value) as $Val);
    });
  }
}
...
class _$VerificationStateImpl implements _VerificationState {
  const _$VerificationStateImpl(
      ...
      @VerificationStateVerifiedStatusConverter() required this.verifiedStatus,
      @VerificationStateTrustedVerifierStatusConverter()
  ...
  @override
  @VerificationStateVerifiedStatusConverter()
  final VerificationStateVerifiedStatus verifiedStatus;

  /// The user's status as a trusted verifier.
  @override
  @VerificationStateTrustedVerifierStatusConverter()
  final VerificationStateTrustedVerifierStatus trustedVerifierStatus;
...
abstract class _VerificationState implements VerificationState {
  const factory _VerificationState(
      ...
      required final List<VerificationView> verifications,
      @VerificationStateVerifiedStatusConverter()
      required final VerificationStateVerifiedStatus verifiedStatus,
      @VerificationStateTrustedVerifierStatusConverter()
      required final VerificationStateTrustedVerifierStatus
          trustedVerifierStatus,
