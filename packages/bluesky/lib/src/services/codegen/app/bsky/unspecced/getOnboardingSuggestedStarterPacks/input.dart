...
@freezed
abstract class UnspeccedGetOnboardingSuggestedStarterPacksInput
    with _$UnspeccedGetOnboardingSuggestedStarterPacksInput {
...
final class UnspeccedGetOnboardingSuggestedStarterPacksInputConverter
  ...
  @override
  UnspeccedGetOnboardingSuggestedStarterPacksInput fromJson(
    Map<String, dynamic> json,
  ) {
    return UnspeccedGetOnboardingSuggestedStarterPacksInput.fromJson(
      translate(
        json,
        UnspeccedGetOnboardingSuggestedStarterPacksInput.knownProps,
      ),
    );
  }
