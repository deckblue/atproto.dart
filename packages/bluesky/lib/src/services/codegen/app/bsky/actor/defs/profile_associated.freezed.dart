...
mixin _$ProfileAssociated {
  ...
  @ProfileAssociatedGermConverter()
  ProfileAssociatedGerm? get germ => throw _privateConstructorUsedError;
...
class _$ProfileAssociatedCopyWithImpl<$Res, $Val extends ProfileAssociated>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      germ: freezed == germ
          ? _value.germ
          : germ // ignore: cast_nullable_to_non_nullable
              as ProfileAssociatedGerm?,
  ...
  $ProfileAssociatedGermCopyWith<$Res>? get germ {
    ...
    return $ProfileAssociatedGermCopyWith<$Res>(_value.germ!, (value) {
      return _then(_value.copyWith(germ: value) as $Val);
    });
  }
}
...
class _$ProfileAssociatedImpl implements _ProfileAssociated {
  const _$ProfileAssociatedImpl(
      ...
      @ProfileAssociatedGermConverter() this.germ,
  ...
  @override
  @ProfileAssociatedGermConverter()
  final ProfileAssociatedGerm? germ;
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.germ, germ) || other.germ == germ) &&
...
abstract class _ProfileAssociated implements ProfileAssociated {
  const factory _ProfileAssociated(
      ...
      @ProfileAssociatedActivitySubscriptionConverter()
      final ProfileAssociatedActivitySubscription? activitySubscription,
      @ProfileAssociatedGermConverter() final ProfileAssociatedGerm? germ,
  ...
  @override
  @ProfileAssociatedGermConverter()
  ProfileAssociatedGerm? get germ;
  @override
  Map<String, dynamic>? get $unknown;
