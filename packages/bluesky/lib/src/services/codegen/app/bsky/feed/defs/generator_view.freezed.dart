...
class _$GeneratorViewCopyWithImpl<$Res, $Val extends GeneratorView>
  ...
  @pragma('vm:prefer-inline')
  $GeneratorViewContentModeCopyWith<$Res>? get contentMode {
    if (_value.contentMode == null) {
      return null;
    }

    return $GeneratorViewContentModeCopyWith<$Res>(_value.contentMode!,
        (value) {
      return _then(_value.copyWith(contentMode: value) as $Val);
    });
  }
}
