        ...
        final val = _$ProfileAssociatedImpl(
          ...
          germ: $checkedConvert(
              ...
              (v) => _$JsonConverterFromJson<Map<String, dynamic>,
                  ...
                  v, const ProfileAssociatedGermConverter().fromJson)),
...
Map<String, dynamic> _$$ProfileAssociatedImplToJson(
    ...
    <String, dynamic>{
      ...
      if (_$JsonConverterToJson<Map<String, dynamic>, ProfileAssociatedGerm>(
              instance.germ, const ProfileAssociatedGermConverter().toJson)
          case final value?)
        'germ': value,
