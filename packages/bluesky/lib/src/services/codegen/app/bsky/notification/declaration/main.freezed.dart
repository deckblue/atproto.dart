...
mixin _$NotificationDeclarationRecord {
  ...
  NotificationDeclarationAllowSubscriptions get allowSubscriptions =>
...
abstract class $NotificationDeclarationRecordCopyWith<$Res> {
  ...
  $Res call(
      {String $type,
      @NotificationDeclarationAllowSubscriptionsConverter()
      NotificationDeclarationAllowSubscriptions allowSubscriptions,
      Map<String, dynamic>? $unknown});

  $NotificationDeclarationAllowSubscriptionsCopyWith<$Res>
...
class _$NotificationDeclarationRecordCopyWithImpl<$Res,
    ...
    return _then(_value.copyWith(
      ...
      allowSubscriptions: null == allowSubscriptions
          ...
          : allowSubscriptions // ignore: cast_nullable_to_non_nullable
              as NotificationDeclarationAllowSubscriptions,
  ...
  $NotificationDeclarationAllowSubscriptionsCopyWith<$Res>
      get allowSubscriptions {
    return $NotificationDeclarationAllowSubscriptionsCopyWith<$Res>(
        _value.allowSubscriptions, (value) {
      return _then(_value.copyWith(allowSubscriptions: value) as $Val);
    });
  }
}
...
class _$NotificationDeclarationRecordImpl
  ...
  @override
  @NotificationDeclarationAllowSubscriptionsConverter()
  final NotificationDeclarationAllowSubscriptions allowSubscriptions;
...
abstract class _NotificationDeclarationRecord
  ...
  const factory _NotificationDeclarationRecord(
          {final String $type,
          @NotificationDeclarationAllowSubscriptionsConverter()
          required final NotificationDeclarationAllowSubscriptions
              allowSubscriptions,
          final Map<String, dynamic>? $unknown}) =
      _$NotificationDeclarationRecordImpl;
