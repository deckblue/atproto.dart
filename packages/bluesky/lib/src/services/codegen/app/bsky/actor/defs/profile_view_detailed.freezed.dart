...
mixin _$ProfileViewDetailed {
  ...
  Map<String, dynamic>? get debug => throw _privateConstructorUsedError;
...
class _$ProfileViewDetailedImpl implements _ProfileViewDetailed {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(other._debug, _debug) &&
  ...
  int get hashCode => Object.hashAll([
        ...
        verification,
        status,
        const DeepCollectionEquality().hash(_debug),
