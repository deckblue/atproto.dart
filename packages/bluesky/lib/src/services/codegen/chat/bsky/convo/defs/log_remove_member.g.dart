...
_$LogRemoveMemberImpl _$$LogRemoveMemberImplFromJson(Map json) =>
    $checkedCreate(
      r'_$LogRemoveMemberImpl',
      json,
      ($checkedConvert) {
        final val = _$LogRemoveMemberImpl(
...
Map<String, dynamic> _$$LogRemoveMemberImplToJson(
        _$LogRemoveMemberImpl instance) =>
    <String, dynamic>{
