...
_$LogAddMemberImpl _$$LogAddMemberImplFromJson(Map json) => $checkedCreate(
      r'_$LogAddMemberImpl',
      json,
      ($checkedConvert) {
        final val = _$LogAddMemberImpl(
...
Map<String, dynamic> _$$LogAddMemberImplToJson(_$LogAddMemberImpl instance) =>
    <String, dynamic>{
