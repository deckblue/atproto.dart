      ...
      ($checkedConvert) {
        final val = _$GroupConvoImpl(
          ...
          unreadJoinRequestCount: $checkedConvert(
              'unreadJoinRequestCount', (v) => (v as num?)?.toInt()),
...
Map<String, dynamic> _$$GroupConvoImplToJson(_$GroupConvoImpl instance) =>
    <String, dynamic>{
      ...
      if (_$JsonConverterToJson<Map<String, dynamic>, JoinLinkView>(
          ...
          case final value?)
        'joinLink': value,
      if (instance.joinRequestCount case final value?)
      ...
      'name': instance.name,
      if (instance.unreadJoinRequestCount case final value?)
        'unreadJoinRequestCount': value,
