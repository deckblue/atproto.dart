...
_$EventGroupChatJoinRequestRejectedImpl
    _$$EventGroupChatJoinRequestRejectedImplFromJson(Map json) =>
        $checkedCreate(
          r'_$EventGroupChatJoinRequestRejectedImpl',
          json,
          ($checkedConvert) {
            final val = _$EventGroupChatJoinRequestRejectedImpl(
              $type: $checkedConvert(
                  r'$type',
                  (v) =>
                      v as String? ??
...
Map<String, dynamic> _$$EventGroupChatJoinRequestRejectedImplToJson(
        _$EventGroupChatJoinRequestRejectedImpl instance) =>
    <String, dynamic>{
