...
_$EventGroupChatMemberAddedImpl _$$EventGroupChatMemberAddedImplFromJson(
        Map json) =>
    $checkedCreate(
      r'_$EventGroupChatMemberAddedImpl',
      json,
      ($checkedConvert) {
        final val = _$EventGroupChatMemberAddedImpl(
          $type: $checkedConvert(
              r'$type',
              (v) =>
                  v as String? ??
          ...
          requestMembersCount:
              $checkedConvert('requestMembersCount', (v) => (v as num).toInt()),
          rev: $checkedConvert('rev', (v) => v as String),
          subjectDid: $checkedConvert('subjectDid', (v) => v as String),
          subjectFollowsOwner:
              $checkedConvert('subjectFollowsOwner', (v) => v as bool),
...
Map<String, dynamic> _$$EventGroupChatMemberAddedImplToJson(
        _$EventGroupChatMemberAddedImpl instance) =>
    <String, dynamic>{
