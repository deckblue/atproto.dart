...
EventGroupChatJoinRequest _$EventGroupChatJoinRequestFromJson(
    Map<String, dynamic> json) {
  return _EventGroupChatJoinRequest.fromJson(json);
}
...
mixin _$EventGroupChatJoinRequest {
  ...
  $EventGroupChatJoinRequestCopyWith<EventGroupChatJoinRequest> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $EventGroupChatJoinRequestCopyWith<$Res> {
  factory $EventGroupChatJoinRequestCopyWith(EventGroupChatJoinRequest value,
          $Res Function(EventGroupChatJoinRequest) then) =
      _$EventGroupChatJoinRequestCopyWithImpl<$Res, EventGroupChatJoinRequest>;
  @useResult
  $Res call(
      {String $type,
      String actorDid,
...
class _$EventGroupChatJoinRequestCopyWithImpl<$Res,
        $Val extends EventGroupChatJoinRequest>
    implements $EventGroupChatJoinRequestCopyWith<$Res> {
  _$EventGroupChatJoinRequestCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$EventGroupChatJoinRequestImplCopyWith<$Res>
    implements $EventGroupChatJoinRequestCopyWith<$Res> {
  factory _$$EventGroupChatJoinRequestImplCopyWith(
          _$EventGroupChatJoinRequestImpl value,
          $Res Function(_$EventGroupChatJoinRequestImpl) then) =
      __$$EventGroupChatJoinRequestImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String $type,
...
/// @nodoc
class __$$EventGroupChatJoinRequestImplCopyWithImpl<$Res>
    extends _$EventGroupChatJoinRequestCopyWithImpl<$Res,
        _$EventGroupChatJoinRequestImpl>
    implements _$$EventGroupChatJoinRequestImplCopyWith<$Res> {
  __$$EventGroupChatJoinRequestImplCopyWithImpl(
      _$EventGroupChatJoinRequestImpl _value,
      $Res Function(_$EventGroupChatJoinRequestImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$EventGroupChatJoinRequestImpl(
      $type: null == $type
          ? _value.$type
          : $type // ignore: cast_nullable_to_non_nullable
              as String,
...
class _$EventGroupChatJoinRequestImpl implements _EventGroupChatJoinRequest {
  const _$EventGroupChatJoinRequestImpl(
      {this.$type =
  ...
  factory _$EventGroupChatJoinRequestImpl.fromJson(Map<String, dynamic> json) =>
      _$$EventGroupChatJoinRequestImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$EventGroupChatJoinRequestImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$EventGroupChatJoinRequestImplCopyWith<_$EventGroupChatJoinRequestImpl>
      get copyWith => __$$EventGroupChatJoinRequestImplCopyWithImpl<
          _$EventGroupChatJoinRequestImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$EventGroupChatJoinRequestImplToJson(
      this,
    );
  }
}

abstract class _EventGroupChatJoinRequest implements EventGroupChatJoinRequest {
  const factory _EventGroupChatJoinRequest(
      {final String $type,
      ...
      final Map<String, dynamic>? $unknown}) = _$EventGroupChatJoinRequestImpl;

  factory _EventGroupChatJoinRequest.fromJson(Map<String, dynamic> json) =
      _$EventGroupChatJoinRequestImpl.fromJson;
