...
_$EventGroupChatMemberLeftImpl _$$EventGroupChatMemberLeftImplFromJson(
        Map json) =>
    $checkedCreate(
      r'_$EventGroupChatMemberLeftImpl',
      json,
      ($checkedConvert) {
        final val = _$EventGroupChatMemberLeftImpl(
          $type: $checkedConvert(
              r'$type',
              (v) =>
                  v as String? ??
          ...
          leaveMethod: $checkedConvert(
              'leaveMethod',
              (v) => const EventGroupChatMemberLeftLeaveMethodConverter()
...
Map<String, dynamic> _$$EventGroupChatMemberLeftImplToJson(
        _$EventGroupChatMemberLeftImpl instance) =>
    <String, dynamic>{
      ...
      'leaveMethod': const EventGroupChatMemberLeftLeaveMethodConverter()
          .toJson(instance.leaveMethod),
