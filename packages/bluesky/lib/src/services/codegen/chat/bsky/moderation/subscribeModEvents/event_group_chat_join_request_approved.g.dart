...
_$EventGroupChatJoinRequestApprovedImpl
    _$$EventGroupChatJoinRequestApprovedImplFromJson(Map json) =>
        $checkedCreate(
          r'_$EventGroupChatJoinRequestApprovedImpl',
          json,
          ($checkedConvert) {
            final val = _$EventGroupChatJoinRequestApprovedImpl(
              $type: $checkedConvert(
                  r'$type',
                  (v) =>
                      v as String? ??
              ...
              groupMemberCount: $checkedConvert(
                  'groupMemberCount', (v) => (v as num).toInt()),
...
Map<String, dynamic> _$$EventGroupChatJoinRequestApprovedImplToJson(
        _$EventGroupChatJoinRequestApprovedImpl instance) =>
    <String, dynamic>{
