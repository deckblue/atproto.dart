...
mixin _$ChatPreference {
  ...
  @ChatPreferenceIncludeConverter()
  ChatPreferenceInclude get include => throw _privateConstructorUsedError;
...
abstract class $ChatPreferenceCopyWith<$Res> {
  ...
  $Res call(
      {String $type,
      @ChatPreferenceIncludeConverter() ChatPreferenceInclude include,
      bool push,
...
class _$ChatPreferenceCopyWithImpl<$Res, $Val extends ChatPreference>
  ...
  @pragma('vm:prefer-inline')
  $ChatPreferenceIncludeCopyWith<$Res> get include {
    return $ChatPreferenceIncludeCopyWith<$Res>(_value.include, (value) {
...
class _$ChatPreferenceImpl implements _ChatPreference {
  const _$ChatPreferenceImpl(
      {this.$type = 'chat.bsky.notification.defs#chatPreference',
      @ChatPreferenceIncludeConverter() required this.include,
      required this.push,
  ...
  @override
  @ChatPreferenceIncludeConverter()
  final ChatPreferenceInclude include;
  @override
  final bool push;
...
abstract class _ChatPreference implements ChatPreference {
  const factory _ChatPreference(
      {final String $type,
      @ChatPreferenceIncludeConverter()
      required final ChatPreferenceInclude include,
  ...
  @override
  @ChatPreferenceIncludeConverter()
  ChatPreferenceInclude get include;
  @override
  bool get push;
  @override
  Map<String, dynamic>? get $unknown;
