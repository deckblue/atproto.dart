...
abstract class ConvoMuteConvoOutput with _$ConvoMuteConvoOutput {
  ...
  factory ConvoMuteConvoOutput.fromJson(Map<String, Object?> json) =>
      _$ConvoMuteConvoOutputFromJson(json);
}

final class ConvoMuteConvoOutputConverter
    extends JsonConverter<ConvoMuteConvoOutput, Map<String, dynamic>> {
  const ConvoMuteConvoOutputConverter();
