...
_$EventGroupChatJoinRequestImpl _$$EventGroupChatJoinRequestImplFromJson(
        Map json) =>
    $checkedCreate(
      r'_$EventGroupChatJoinRequestImpl',
      json,
      ($checkedConvert) {
        final val = _$EventGroupChatJoinRequestImpl(
          $type: $checkedConvert(
              r'$type',
              (v) =>
                  v as String? ??
...
Map<String, dynamic> _$$EventGroupChatJoinRequestImplToJson(
        _$EventGroupChatJoinRequestImpl instance) =>
    <String, dynamic>{
