...
mixin _$LogReadMessage {
  ...
  @ULogReadMessageMessageConverter()
  ULogReadMessageMessage get message => throw _privateConstructorUsedError;
...
abstract class $LogReadMessageCopyWith<$Res> {
  ...
  $Res call(
      ...
      String rev,
      String convoId,
      @ULogReadMessageMessageConverter() ULogReadMessageMessage message,
...
class _$LogReadMessageCopyWithImpl<$Res, $Val extends LogReadMessage>
  ...
  @pragma('vm:prefer-inline')
  $ULogReadMessageMessageCopyWith<$Res> get message {
    return $ULogReadMessageMessageCopyWith<$Res>(_value.message, (value) {
...
class _$LogReadMessageImpl implements _LogReadMessage {
  const _$LogReadMessageImpl(
      ...
      @ULogReadMessageMessageConverter() required this.message,
  ...
  @override
  @ULogReadMessageMessageConverter()
  final ULogReadMessageMessage message;
...
abstract class _LogReadMessage implements LogReadMessage {
  const factory _LogReadMessage(
      ...
      @ULogReadMessageMessageConverter()
      required final ULogReadMessageMessage message,
      final Map<String, dynamic>? $unknown}) = _$LogReadMessageImpl;
  ...
  @override
  @ULogReadMessageMessageConverter()
  ULogReadMessageMessage get message;
  @override
  Map<String, dynamic>? get $unknown;
