...
_$GroupRequestJoinOutputImpl _$$GroupRequestJoinOutputImplFromJson(Map json) =>
    $checkedCreate(
      r'_$GroupRequestJoinOutputImpl',
      json,
      ($checkedConvert) {
        final val = _$GroupRequestJoinOutputImpl(
          status: $checkedConvert(
              'status',
              (v) => const GroupRequestJoinStatusConverter()
...
Map<String, dynamic> _$$GroupRequestJoinOutputImplToJson(
        _$GroupRequestJoinOutputImpl instance) =>
    <String, dynamic>{
