...
_$EventGroupChatMemberJoinedImpl _$$EventGroupChatMemberJoinedImplFromJson(
        Map json) =>
    $checkedCreate(
      r'_$EventGroupChatMemberJoinedImpl',
      json,
      ($checkedConvert) {
        final val = _$EventGroupChatMemberJoinedImpl(
          $type: $checkedConvert(
              r'$type',
              (v) =>
                  v as String? ??
...
Map<String, dynamic> _$$EventGroupChatMemberJoinedImplToJson(
        _$EventGroupChatMemberJoinedImpl instance) =>
    <String, dynamic>{
