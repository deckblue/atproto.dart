...
abstract class ConvoLeaveConvoInput with _$ConvoLeaveConvoInput {
  ...
  factory ConvoLeaveConvoInput.fromJson(Map<String, Object?> json) =>
      _$ConvoLeaveConvoInputFromJson(json);
}

final class ConvoLeaveConvoInputConverter
    extends JsonConverter<ConvoLeaveConvoInput, Map<String, dynamic>> {
  const ConvoLeaveConvoInputConverter();
