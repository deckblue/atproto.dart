...
// Project imports:
import '../../../../chat/bsky/notification/defs/preferences.dart';
...
@freezed
abstract class NotificationPutPreferencesOutput
    with _$NotificationPutPreferencesOutput {
...
final class NotificationPutPreferencesOutputConverter extends JsonConverter<
  ...
  @override
  NotificationPutPreferencesOutput fromJson(Map<String, dynamic> json) {
    return NotificationPutPreferencesOutput.fromJson(
      translate(json, NotificationPutPreferencesOutput.knownProps),
    );
  }

  @override
  Map<String, dynamic> toJson(NotificationPutPreferencesOutput object) =>
