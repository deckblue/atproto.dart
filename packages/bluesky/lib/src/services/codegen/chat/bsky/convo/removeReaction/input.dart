...
abstract class ConvoRemoveReactionInput with _$ConvoRemoveReactionInput {
  ...
  factory ConvoRemoveReactionInput.fromJson(Map<String, Object?> json) =>
      _$ConvoRemoveReactionInputFromJson(json);
}

final class ConvoRemoveReactionInputConverter
    extends JsonConverter<ConvoRemoveReactionInput, Map<String, dynamic>> {
  const ConvoRemoveReactionInputConverter();
