...
_$JoinRequestConvoViewImpl _$$JoinRequestConvoViewImplFromJson(Map json) =>
    $checkedCreate(
      r'_$JoinRequestConvoViewImpl',
      json,
      ($checkedConvert) {
        final val = _$JoinRequestConvoViewImpl(
          $type: $checkedConvert(
              r'$type',
              (v) =>
                  v as String? ?? 'chat.bsky.group.defs#joinRequestConvoView'),
...
Map<String, dynamic> _$$JoinRequestConvoViewImplToJson(
        _$JoinRequestConvoViewImpl instance) =>
    <String, dynamic>{
