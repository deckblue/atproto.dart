...
mixin _$VerificationRevokeVerificationsOutput {
  @AtUriConverter()
  List<AtUri> get revokedVerifications => throw _privateConstructorUsedError;
...
abstract class $VerificationRevokeVerificationsOutputCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {@AtUriConverter() List<AtUri> revokedVerifications,
...
class _$VerificationRevokeVerificationsOutputImpl
  ...
  const _$VerificationRevokeVerificationsOutputImpl(
      {@AtUriConverter() required final List<AtUri> revokedVerifications,
      @RevokeErrorConverter()
  ...
  @override
  @AtUriConverter()
  List<AtUri> get revokedVerifications {
