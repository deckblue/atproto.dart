...
mixin _$TeamAddMemberInput {
  ...
  @TeamAddMemberRoleConverter()
  TeamAddMemberRole get role => throw _privateConstructorUsedError;
...
abstract class $TeamAddMemberInputCopyWith<$Res> {
  ...
  $Res call(
      {String did,
      @TeamAddMemberRoleConverter() TeamAddMemberRole role,
...
class _$TeamAddMemberInputCopyWithImpl<$Res, $Val extends TeamAddMemberInput>
  ...
  @pragma('vm:prefer-inline')
  $TeamAddMemberRoleCopyWith<$Res> get role {
    return $TeamAddMemberRoleCopyWith<$Res>(_value.role, (value) {
...
class _$TeamAddMemberInputImpl implements _TeamAddMemberInput {
  const _$TeamAddMemberInputImpl(
      {required this.did,
      @TeamAddMemberRoleConverter() required this.role,
...
abstract class _TeamAddMemberInput implements TeamAddMemberInput {
  const factory _TeamAddMemberInput(
      ...
      @TeamAddMemberRoleConverter() required final TeamAddMemberRole role,
