...
class _$AssignmentViewImpl implements _AssignmentView {
  const _$AssignmentViewImpl(
      {this.$type = 'tools.ozone.queue.defs#assignmentView',
      required this.id,
      required this.did,
  ...
  @override
  String toString() {
    return 'AssignmentView(\$type: ${$type}, id: $id, did: $did, moderator: $moderator, queue: $queue, startAt: $startAt, endAt: $endAt, \$unknown: ${$unknown})';
  }
  ...
  int get hashCode => Object.hash(runtimeType, $type, id, did, moderator, queue,
      startAt, endAt, const DeepCollectionEquality().hash(_$unknown));
