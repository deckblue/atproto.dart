      ...
      ($checkedConvert) {
        final val = _$SubjectStatusViewImpl(
          ...
          accountStrike: $checkedConvert(
              'accountStrike',
              (v) =>
                  _$JsonConverterFromJson<Map<String, dynamic>, AccountStrike>(
                      v, const AccountStrikeConverter().fromJson)),
...
Map<String, dynamic> _$$SubjectStatusViewImplToJson(
    ...
    <String, dynamic>{
      ...
      if (_$JsonConverterToJson<Map<String, dynamic>, RecordsStats>(
          ...
          case final value?)
        'recordsStats': value,
      if (_$JsonConverterToJson<Map<String, dynamic>, AccountStrike>(
              instance.accountStrike, const AccountStrikeConverter().toJson)
          case final value?)
        'accountStrike': value,
