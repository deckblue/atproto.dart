...
mixin _$SettingRemoveOptionsInput {
  ...
  SettingRemoveOptionsScope get scope => throw _privateConstructorUsedError;
...
abstract class $SettingRemoveOptionsInputCopyWith<$Res> {
  ...
  $Res call(
      {List<String> keys,
      @SettingRemoveOptionsScopeConverter() SettingRemoveOptionsScope scope,
...
class _$SettingRemoveOptionsInputCopyWithImpl<$Res,
  ...
  @pragma('vm:prefer-inline')
  $SettingRemoveOptionsScopeCopyWith<$Res> get scope {
    return $SettingRemoveOptionsScopeCopyWith<$Res>(_value.scope, (value) {
...
class _$SettingRemoveOptionsInputImpl implements _SettingRemoveOptionsInput {
  const _$SettingRemoveOptionsInputImpl(
      ...
      @SettingRemoveOptionsScopeConverter() required this.scope,
  ...
  @override
  @SettingRemoveOptionsScopeConverter()
  final SettingRemoveOptionsScope scope;
...
abstract class _SettingRemoveOptionsInput implements SettingRemoveOptionsInput {
  const factory _SettingRemoveOptionsInput(
      {required final List<String> keys,
      @SettingRemoveOptionsScopeConverter()
      required final SettingRemoveOptionsScope scope,
  ...
  @override
  @SettingRemoveOptionsScopeConverter()
  SettingRemoveOptionsScope get scope;
  @override
  Map<String, dynamic>? get $unknown;
