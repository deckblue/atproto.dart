        ...
        final val = _$ModerationQueryStatusesInputImpl(
          ...
          reviewState: $checkedConvert(
              ...
              (v) => _$JsonConverterFromJson<String,
                      ModerationQueryStatusesReviewState>(
                  v,
          ...
          minStrikeCount:
              $checkedConvert('minStrikeCount', (v) => (v as num?)?.toInt()),
...
Map<String, dynamic> _$$ModerationQueryStatusesInputImplToJson(
    ...
    <String, dynamic>{
      ...
      if (_$JsonConverterToJson<String, ModerationQueryStatusesReviewState>(
          ...
          case final value?)
        'reviewState': value,
      if (instance.ignoreSubjects case final value?) 'ignoreSubjects': value,
      ...
      if (instance.minStrikeCount case final value?) 'minStrikeCount': value,
