...
mixin _$ModerationQueryStatusesInput {
  ...
  ModerationQueryStatusesReviewState? get reviewState =>
  ...
  ModerationQueryStatusesSubjectType? get subjectType =>
      throw _privateConstructorUsedError;
  ...
  int? get minStrikeCount => throw _privateConstructorUsedError;
  ...
  ModerationQueryStatusesAgeAssuranceState? get ageAssuranceState =>
      throw _privateConstructorUsedError;
...
abstract class $ModerationQueryStatusesInputCopyWith<$Res> {
  ...
  $ModerationQueryStatusesAgeAssuranceStateCopyWith<$Res>?
      get ageAssuranceState;
}
...
class _$ModerationQueryStatusesInputCopyWithImpl<$Res,
    ...
    return _then(_value.copyWith(
      ...
      reviewState: freezed == reviewState
          ...
          : reviewState // ignore: cast_nullable_to_non_nullable
              as ModerationQueryStatusesReviewState?,
      ...
      subjectType: freezed == subjectType
          ...
          : subjectType // ignore: cast_nullable_to_non_nullable
              as ModerationQueryStatusesSubjectType?,
      ...
      minPriorityScore: freezed == minPriorityScore
          ...
          : minPriorityScore // ignore: cast_nullable_to_non_nullable
              as int?,
      minStrikeCount: freezed == minStrikeCount
          ? _value.minStrikeCount
          : minStrikeCount // ignore: cast_nullable_to_non_nullable
              as int?,
      ageAssuranceState: freezed == ageAssuranceState
          ...
          : ageAssuranceState // ignore: cast_nullable_to_non_nullable
              as ModerationQueryStatusesAgeAssuranceState?,
  ...
  @pragma('vm:prefer-inline')
  $ModerationQueryStatusesReviewStateCopyWith<$Res>? get reviewState {
    if (_value.reviewState == null) {
      return null;
    }

    return $ModerationQueryStatusesReviewStateCopyWith<$Res>(
        _value.reviewState!, (value) {
  ...
  $ModerationQueryStatusesSubjectTypeCopyWith<$Res>? get subjectType {
    ...
    return $ModerationQueryStatusesSubjectTypeCopyWith<$Res>(
        _value.subjectType!, (value) {
  ...
  $ModerationQueryStatusesAgeAssuranceStateCopyWith<$Res>?
    ...
    return $ModerationQueryStatusesAgeAssuranceStateCopyWith<$Res>(
...
class _$ModerationQueryStatusesInputImpl
  ...
  const _$ModerationQueryStatusesInputImpl(
      ...
      @ModerationQueryStatusesSubjectTypeConverter() this.subjectType,
  ...
  @override
  @ModerationQueryStatusesReviewStateConverter()
  final ModerationQueryStatusesReviewState? reviewState;
  ...
  @override
  @ModerationQueryStatusesSubjectTypeConverter()
  final ModerationQueryStatusesSubjectType? subjectType;
  ...
  /// If specified, only subjects that belong to an account that has at least this many active strikes will be returned.
  @override
  final int? minStrikeCount;

  /// If specified, only subjects with the given age assurance state will be returned.
  @override
  @ModerationQueryStatusesAgeAssuranceStateConverter()
  final ModerationQueryStatusesAgeAssuranceState? ageAssuranceState;
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.minStrikeCount, minStrikeCount) ||
                other.minStrikeCount == minStrikeCount) &&
