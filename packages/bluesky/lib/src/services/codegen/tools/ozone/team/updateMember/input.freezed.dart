...
mixin _$TeamUpdateMemberInput {
  ...
  @TeamUpdateMemberRoleConverter()
  TeamUpdateMemberRole? get role => throw _privateConstructorUsedError;
...
class _$TeamUpdateMemberInputCopyWithImpl<$Res,
  ...
  $TeamUpdateMemberRoleCopyWith<$Res>? get role {
    ...
    return $TeamUpdateMemberRoleCopyWith<$Res>(_value.role!, (value) {
...
class _$TeamUpdateMemberInputImpl implements _TeamUpdateMemberInput {
  const _$TeamUpdateMemberInputImpl(
      {required this.did,
      this.disabled,
      @TeamUpdateMemberRoleConverter() this.role,
  ...
  @override
  @TeamUpdateMemberRoleConverter()
  final TeamUpdateMemberRole? role;
...
abstract class _TeamUpdateMemberInput implements TeamUpdateMemberInput {
  const factory _TeamUpdateMemberInput(
      ...
      final bool? disabled,
      @TeamUpdateMemberRoleConverter() final TeamUpdateMemberRole? role,
