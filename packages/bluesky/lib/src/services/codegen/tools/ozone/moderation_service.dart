        ...
        await $ctx.get(
          ...
          parameters: {
            ...
            if (reportedBefore != null)
              'reportedBefore': iso8601(reportedBefore),
            ...
            if (reviewedBefore != null)
              'reviewedBefore': iso8601(reviewedBefore),
...
base class ModerationService {
  ...
  Future<XRPCResponse<CancellationResults>> cancelScheduledActions({
    ...
    Map<String, String>? $unknown,
      ...
      await toolsOzoneModerationCancelScheduledActions(
        subjects: subjects,
        comment: comment,
        $ctx: ctx,
        $service: $service,
  ...
  Future<XRPCResponse<ModEventView>> emitEvent({
    ...
    Map<String, String>? $unknown,
      ...
      await toolsOzoneModerationEmitEvent(
        event: event,
        subject: subject,
  ...
  Future<XRPCResponse<ModerationGetAccountTimelineOutput>> getAccountTimeline({
    ...
    Map<String, String>? $unknown,
      ...
      await toolsOzoneModerationGetAccountTimeline(
        did: did,
        $ctx: ctx,
        $service: $service,
        $headers: $headers,
  ...
  Future<XRPCResponse<ModEventViewDetail>> getEvent({
    ...
    Map<String, String>? $unknown,
      ...
      await toolsOzoneModerationGetEvent(
        id: id,
        $ctx: ctx,
        $service: $service,
        $headers: $headers,
  ...
  Future<XRPCResponse<RecordViewDetail>> getRecord({
    ...
    Map<String, String>? $unknown,
      ...
      await toolsOzoneModerationGetRecord(
        uri: uri,
        cid: cid,
        $ctx: ctx,
        $service: $service,
  ...
  Future<XRPCResponse<ModerationGetRecordsOutput>> getRecords({
    ...
    Map<String, String>? $unknown,
      ...
      await toolsOzoneModerationGetRecords(
        uris: uris,
        $ctx: ctx,
        $service: $service,
        $headers: $headers,
  ...
  Future<XRPCResponse<RepoViewDetail>> getRepo({
    ...
    Map<String, String>? $unknown,
      ...
      await toolsOzoneModerationGetRepo(
        did: did,
        $ctx: ctx,
        $service: $service,
        $headers: $headers,
  ...
  Future<XRPCResponse<ModerationGetReporterStatsOutput>> getReporterStats({
    ...
    Map<String, String>? $unknown,
      ...
      await toolsOzoneModerationGetReporterStats(
        dids: dids,
        $ctx: ctx,
        $service: $service,
        $headers: $headers,
  ...
  Future<XRPCResponse<ModerationGetReposOutput>> getRepos({
    ...
    Map<String, String>? $unknown,
      ...
      await toolsOzoneModerationGetRepos(
        dids: dids,
        $ctx: ctx,
        $service: $service,
        $headers: $headers,
  ...
  Future<XRPCResponse<ModerationGetSubjectsOutput>> getSubjects({
    ...
    Map<String, String>? $unknown,
      ...
      await toolsOzoneModerationGetSubjects(
        subjects: subjects,
        $ctx: ctx,
        $service: $service,
        $headers: $headers,
  ...
  Future<XRPCResponse<ModerationListScheduledActionsOutput>>
    ...
    Map<String, String>? $unknown,
          ...
          await toolsOzoneModerationListScheduledActions(
  ...
  Future<XRPCResponse<ModerationQueryEventsOutput>> queryEvents({
    ...
    Map<String, String>? $unknown,
      ...
      await toolsOzoneModerationQueryEvents(
        types: types,
        createdBy: createdBy,
  ...
  Future<XRPCResponse<ModerationQueryStatusesOutput>> queryStatuses({
    ...
    Map<String, String>? $unknown,
      ...
      await toolsOzoneModerationQueryStatuses(
  ...
  Future<XRPCResponse<ScheduledActionResults>> scheduleAction({
    ...
    Map<String, String>? $unknown,
      ...
      await toolsOzoneModerationScheduleAction(
        action: action,
        subjects: subjects,
        createdBy: createdBy,
  ...
  Future<XRPCResponse<ModerationSearchReposOutput>> searchRepos({
    ...
    Map<String, String>? $unknown,
      ...
      await toolsOzoneModerationSearchRepos(
        term: term,
        q: q,
        limit: limit,
        cursor: cursor,
