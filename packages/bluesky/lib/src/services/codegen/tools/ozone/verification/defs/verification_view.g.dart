    ...
    $checkedCreate(
      ...
      ($checkedConvert) {
        final val = _$VerificationViewImpl(
          ...
          revokedAt: $checkedConvert('revokedAt',
              (v) => v == null ? null : DateTime.parse(v as String)),
          revokedBy: $checkedConvert('revokedBy', (v) => v as String?),
          subjectProfile: $checkedConvert(
              'subjectProfile',
              (v) => _$JsonConverterFromJson<Map<String, dynamic>,
                      UVerificationViewSubjectProfile>(v,
                  const UVerificationViewSubjectProfileConverter().fromJson)),
...
Map<String, dynamic> _$$VerificationViewImplToJson(
    ...
    <String, dynamic>{
      ...
      if (_$JsonConverterToJson<Map<String, dynamic>,
          ...
          case final value?)
        'subjectProfile': value,
      if (_$JsonConverterToJson<Map<String, dynamic>,
                  UVerificationViewIssuerProfile>(instance.issuerProfile,
              const UVerificationViewIssuerProfileConverter().toJson)
          case final value?)
        'issuerProfile': value,
      if (_$JsonConverterToJson<Map<String, dynamic>,
                  UVerificationViewSubjectRepo>(instance.subjectRepo,
              const UVerificationViewSubjectRepoConverter().toJson)
          case final value?)
        'subjectRepo': value,
      if (_$JsonConverterToJson<Map<String, dynamic>,
                  UVerificationViewIssuerRepo>(instance.issuerRepo,
