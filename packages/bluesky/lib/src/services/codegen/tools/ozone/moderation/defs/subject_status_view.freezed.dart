...
mixin _$SubjectStatusView {
  ...
  @AccountStrikeConverter()
  AccountStrike? get accountStrike => throw _privateConstructorUsedError;

  /// Current age assurance state of the subject.
  @SubjectStatusViewAgeAssuranceStateConverter()
  SubjectStatusViewAgeAssuranceState? get ageAssuranceState =>
  ...
  SubjectStatusViewAgeAssuranceUpdatedBy? get ageAssuranceUpdatedBy =>
      throw _privateConstructorUsedError;
...
abstract class $SubjectStatusViewCopyWith<$Res> {
  ...
  $SubjectStatusViewAgeAssuranceUpdatedByCopyWith<$Res>?
      get ageAssuranceUpdatedBy;
}
...
class _$SubjectStatusViewCopyWithImpl<$Res, $Val extends SubjectStatusView>
  ...
  $Res call({
    ...
    Object? accountStrike = freezed,
    Object? ageAssuranceState = freezed,
    Object? ageAssuranceUpdatedBy = freezed,
    ...
    return _then(_value.copyWith(
      ...
      recordsStats: freezed == recordsStats
          ...
          : recordsStats // ignore: cast_nullable_to_non_nullable
              as RecordsStats?,
      accountStrike: freezed == accountStrike
          ? _value.accountStrike
          : accountStrike // ignore: cast_nullable_to_non_nullable
              as AccountStrike?,
      ageAssuranceState: freezed == ageAssuranceState
          ? _value.ageAssuranceState
          : ageAssuranceState // ignore: cast_nullable_to_non_nullable
              as SubjectStatusViewAgeAssuranceState?,
      ageAssuranceUpdatedBy: freezed == ageAssuranceUpdatedBy
          ? _value.ageAssuranceUpdatedBy
          : ageAssuranceUpdatedBy // ignore: cast_nullable_to_non_nullable
              as SubjectStatusViewAgeAssuranceUpdatedBy?,
  ...
  @pragma('vm:prefer-inline')
  $AccountStrikeCopyWith<$Res>? get accountStrike {
    if (_value.accountStrike == null) {
      return null;
    }

    return $AccountStrikeCopyWith<$Res>(_value.accountStrike!, (value) {
      return _then(_value.copyWith(accountStrike: value) as $Val);
    });
  }
  ...
  @pragma('vm:prefer-inline')
  $SubjectStatusViewAgeAssuranceStateCopyWith<$Res>? get ageAssuranceState {
    if (_value.ageAssuranceState == null) {
      return null;
    }

    return $SubjectStatusViewAgeAssuranceStateCopyWith<$Res>(
        _value.ageAssuranceState!, (value) {
      return _then(_value.copyWith(ageAssuranceState: value) as $Val);
    });
  }
  ...
  $SubjectStatusViewAgeAssuranceUpdatedByCopyWith<$Res>?
      get ageAssuranceUpdatedBy {
    if (_value.ageAssuranceUpdatedBy == null) {
      return null;
    }

    return $SubjectStatusViewAgeAssuranceUpdatedByCopyWith<$Res>(
        _value.ageAssuranceUpdatedBy!, (value) {
      return _then(_value.copyWith(ageAssuranceUpdatedBy: value) as $Val);
    });
  }
}
...
class _$SubjectStatusViewImpl implements _SubjectStatusView {
  const _$SubjectStatusViewImpl(
      ...
      @AccountStrikeConverter() this.accountStrike,
      @SubjectStatusViewAgeAssuranceStateConverter() this.ageAssuranceState,
      @SubjectStatusViewAgeAssuranceUpdatedByConverter()
      this.ageAssuranceUpdatedBy,
  ...
  @override
  @AccountStrikeConverter()
  final AccountStrike? accountStrike;

  /// Current age assurance state of the subject.
  @override
  @SubjectStatusViewAgeAssuranceStateConverter()
  final SubjectStatusViewAgeAssuranceState? ageAssuranceState;

  /// Whether or not the last successful update to age assurance was made by the user or admin.
  @override
  @SubjectStatusViewAgeAssuranceUpdatedByConverter()
  final SubjectStatusViewAgeAssuranceUpdatedBy? ageAssuranceUpdatedBy;
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.accountStrike, accountStrike) ||
                other.accountStrike == accountStrike) &&
            (identical(other.ageAssuranceState, ageAssuranceState) ||
                other.ageAssuranceState == ageAssuranceState) &&
            (identical(other.ageAssuranceUpdatedBy, ageAssuranceUpdatedBy) ||
...
abstract class _SubjectStatusView implements SubjectStatusView {
  const factory _SubjectStatusView(
      ...
      @AccountStrikeConverter() final AccountStrike? accountStrike,
      @SubjectStatusViewAgeAssuranceStateConverter()
      final SubjectStatusViewAgeAssuranceState? ageAssuranceState,
      @SubjectStatusViewAgeAssuranceUpdatedByConverter()
      final SubjectStatusViewAgeAssuranceUpdatedBy? ageAssuranceUpdatedBy,
  ...
  @override
  @AccountStrikeConverter()
  AccountStrike? get accountStrike;
