      ...
      ($checkedConvert) {
        final val = _$ServerRefreshSessionOutputImpl(
          ...
          status: $checkedConvert(
              'status',
              (v) =>
                  _$JsonConverterFromJson<String, ServerRefreshSessionStatus>(
                      v, const ServerRefreshSessionStatusConverter().fromJson)),
...
Map<String, dynamic> _$$ServerRefreshSessionOutputImplToJson(
    ...
    <String, dynamic>{
      ...
      if (_$JsonConverterToJson<String, ServerRefreshSessionStatus>(
              instance.status,
