...
mixin _$ServerCreateSessionOutput {
  ...
  @ServerCreateSessionStatusConverter()
  ServerCreateSessionStatus? get status => throw _privateConstructorUsedError;
...
class _$ServerCreateSessionOutputCopyWithImpl<$Res,
  ...
  $ServerCreateSessionStatusCopyWith<$Res>? get status {
    ...
    return $ServerCreateSessionStatusCopyWith<$Res>(_value.status!, (value) {
...
class _$ServerCreateSessionOutputImpl implements _ServerCreateSessionOutput {
  const _$ServerCreateSessionOutputImpl(
      ...
      this.active,
      @ServerCreateSessionStatusConverter() this.status,
  ...
  @override
  @ServerCreateSessionStatusConverter()
  final ServerCreateSessionStatus? status;
...
abstract class _ServerCreateSessionOutput implements ServerCreateSessionOutput {
  ...
  @override
  @ServerCreateSessionStatusConverter()
  ServerCreateSessionStatus? get status;
  @override
  Map<String, dynamic>? get $unknown;
