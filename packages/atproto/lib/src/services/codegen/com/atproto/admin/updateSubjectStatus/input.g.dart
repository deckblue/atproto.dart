...
_$AdminUpdateSubjectStatusInputImpl
    _$$AdminUpdateSubjectStatusInputImplFromJson(Map json) => $checkedCreate(
          r'_$AdminUpdateSubjectStatusInputImpl',
          json,
          ($checkedConvert) {
            final val = _$AdminUpdateSubjectStatusInputImpl(
...
Map<String, dynamic> _$$AdminUpdateSubjectStatusInputImplToJson(
        _$AdminUpdateSubjectStatusInputImpl instance) =>
    <String, dynamic>{
