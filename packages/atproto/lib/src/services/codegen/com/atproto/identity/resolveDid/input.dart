...
abstract class IdentityResolveDidInput with _$IdentityResolveDidInput {
  ...
  factory IdentityResolveDidInput.fromJson(Map<String, Object?> json) =>
      _$IdentityResolveDidInputFromJson(json);
}

final class IdentityResolveDidInputConverter
    extends JsonConverter<IdentityResolveDidInput, Map<String, dynamic>> {
  const IdentityResolveDidInputConverter();
