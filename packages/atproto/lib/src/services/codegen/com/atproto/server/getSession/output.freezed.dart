...
mixin _$ServerGetSessionOutput {
  ...
  @ServerGetSessionStatusConverter()
  ServerGetSessionStatus? get status => throw _privateConstructorUsedError;
...
class _$ServerGetSessionOutputCopyWithImpl<$Res,
  ...
  $ServerGetSessionStatusCopyWith<$Res>? get status {
    ...
    return $ServerGetSessionStatusCopyWith<$Res>(_value.status!, (value) {
...
class _$ServerGetSessionOutputImpl implements _ServerGetSessionOutput {
  const _$ServerGetSessionOutputImpl(
      ...
      this.active,
      @ServerGetSessionStatusConverter() this.status,
  ...
  @override
  @ServerGetSessionStatusConverter()
  final ServerGetSessionStatus? status;
...
abstract class _ServerGetSessionOutput implements ServerGetSessionOutput {
  const factory _ServerGetSessionOutput(
      ...
      final Map<String, dynamic>? didDoc,
      final bool? active,
      @ServerGetSessionStatusConverter() final ServerGetSessionStatus? status,
  ...
  @override
  @ServerGetSessionStatusConverter()
  ServerGetSessionStatus? get status;
  @override
  Map<String, dynamic>? get $unknown;
